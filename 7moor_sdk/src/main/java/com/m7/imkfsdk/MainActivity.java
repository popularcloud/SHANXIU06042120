...
//        helper.initSdkChat("176e9d90-101e-11ea-ab51-d1631c2f5405", "测试", "123");
          helper.initSdkChat("8ce41210-35c4-11e9-a0e4-85286ffeb05a", "测试", "123");
//        helper.initSdkChat("fa0f5110-82ec-11e7-8ca1-8b4900b05172", "测试", "123");//chch
//        helper.initSdkChat("50bd51c0-abbb-11ea-b0a1-ed165f23f991", "测试", "123");
    }
...
//                .build();
    ...
    private void handlePermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (PickUtils.PermissionUtils.hasAlwaysDeniedPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_PHONE_STATE, Manifest.permission.READ_EXTERNAL_STORAGE)) {
