...
-keep class okio.** {*;}
-keep class com.lwc.shanxiu.bean.** {*;}
-keep class com.lwc.shanxiu.module.bean.** {*;}
-keep class com.lwc.shanxiu.utils.** {*;}
-keep class com.lwc.shanxiu.database.** {*;}
...
-keep class com.lwc.shanxiu.wxapi.**
