...
public class CustomMonthView extends MonthView {
    ...
    public CustomMonthView(Context context) {
        ...
        mCurrentDayPaint.setColor(0xffE7F2FF);
    ...
    protected void onDrawScheme(Canvas canvas, Calendar calendar, int x, int y) {
     ...
     /*   boolean isSelected = isSelected(calendar);
        ...
        String status = calendar.getScheme();
        ...
        canvas.drawCircle(x + mItemWidth / 2, mTextBaseLine + y - mItemHeight / 6 + mRadius + 10, mPointRadius, mPointPaint);
    }
 ...
 /*       if (hasScheme) {*/
        ...
        if (isSelected) {
            canvas.drawText(String.valueOf(calendar.getDay()), cx, cy+10,
                    mSelectTextPaint);
          /*  canvas.drawText(calendar.getLunar(), cx, mTextBaseLine + y + mItemHeight / 10, mSelectedLunarTextPaint);*/
        }else {
            canvas.drawText(String.valueOf(calendar.getDay()), cx, mTextBaseLine + top + 10,
