...
public class FileConfig {
	...
	// 公用文件路径
	/** 应用根目录 */
	public static final String PATH_BASE = Environment.getExternalStorageDirectory().getAbsolutePath() +  "/SHANXIU/";
	/** 应用Log日志 */
	...
	/** 收藏的图片路径 */
	public static final String PATH_PHOTOS = Environment.getExternalStorageDirectory().getAbsolutePath() + "/DCIM/" + "GUANXIU/";
	/** 拍照缓存文件 */
	 ...
	 * 用户头像
	 */
	public static String ICON = PATH_IMAGES + "icon/";
}
