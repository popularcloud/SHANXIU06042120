        ...
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int viewType, int position) {
                ...
                if (!TextUtils.isEmpty(type) && type.equals("1")) {
                    ...
                    IntentUtil.gotoActivity(MsgListFragment.this, InformationDetailsActivity.class, bundle);
                    ...
                    IntentUtil.gotoActivity(MsgListFragment.this, OrderDetailActivity.class, bundle2);
                }
            }
        });
    ...
    private void getMsgList() {
        ...
        HttpRequestUtils.httpRequest(this, "getMsgList", RequestValue.GET_MESSAGE_LIST+myMsg.getMessageType(), map, "GET", new HttpRequestUtils.ResponseListener() {
                ...
                if (common.getStatus().equals("1")) {
                    ...
                    if (page == 1) {
                        ...
                        if (current != null && current.size() > 0) {
                            ...
                            ToastUtil.showToast(MsgListFragment.this, "暂无更多信息");
                            page--;
                        }
                    }
                    ...
                    ToastUtil.showToast(MsgListFragment.this, common.getInfo());
                }
            ...
            public void returnException(Exception e, String msg) {
                ToastUtil.showToast(MsgListFragment.this, msg);
                BGARefreshLayoutUtils.endRefreshing(mBGARefreshLayout);
                BGARefreshLayoutUtils.endLoadingMore(mBGARefreshLayout);
            }
        });
