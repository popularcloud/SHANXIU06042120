 ...
 *
 */
public class QuestionMyGridViewPhotoAdpter extends BaseAdapter{
    ...
    public QuestionMyGridViewPhotoAdpter(Context context, List<String> lists) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = View.inflate(context, R.layout.question_photo_grid_item, null);
