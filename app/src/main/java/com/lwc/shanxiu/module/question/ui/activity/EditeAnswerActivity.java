...
public class EditeAnswerActivity extends BaseActivity {
    ...
    PublishQuestionDetialBean.AnswersBean presentAnswer;
    ...
    protected void findViews() {
        ...
        gridview_show.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(EditeAnswerActivity.this, ImageBrowseActivity.class);
        ...
        user = SharedPreferencesUtils.getInstance(EditeAnswerActivity.this).loadObjectData(User.class);
    }
...
//                            Utils.deleteFile(path.getPath(), CannotMaintainActivity.this);
                            ...
                            pd.dismiss();
                            ToastUtil.showLongToast(EditeAnswerActivity.this, "图片上传失败");
                        }
                    }
                }, null);
    }
        ...
        HttpRequestUtils.httpRequest(this, "获取编辑信息", RequestValue.QUESION_DETAILS + "?quesion_id=" + quesionId, null, "GET", new HttpRequestUtils.ResponseListener() {
            ...
            public void getResponseData(String response) {
                ...
                switch (common.getStatus()) {
                    ...
                    loadAnswer(questionDetialBean);
                    break;
                    default:
                        ToastUtil.showToast(EditeAnswerActivity.this, common.getInfo());
                        break;
                }
            }
    ...
    private void loadAnswer(PublishQuestionDetialBean publishQuestionDetialBean){
        List<PublishQuestionDetialBean.AnswersBean> answers = publishQuestionDetialBean.getAnswers();
        if(answers != null && answers.size() > 0){
            for(int i = 0;i < answers.size();i++){
                if(answers.get(i).getMaintenanceId().equals(user.getUserId())){
                    presentAnswer = answers.get(i);
                    String img = presentAnswer.getAnswerImg();
                    if(!TextUtils.isEmpty(presentAnswer.getAnswerDetail())){
                        et_content.setText(presentAnswer.getAnswerDetail());
                        et_content.setSelection(presentAnswer.getAnswerDetail().length());
                    }
                    if (img != null && !img.equals("")) {
                        String[] imgs = img.split(",");
                        ...
                        adpter = new QuestionMyGridViewPhotoAdpter(EditeAnswerActivity.this, urlStrs);
    ...
    private boolean isVerify(){
        ...
        if (content == null || content.length() < 1) {
            ToastUtil.showToast(EditeAnswerActivity.this, "请填写您的回答内容！");
            return false;
        }
        return true;
    }
    ...
    private void publishData() {
        ...
        String requestPath = RequestValue.QUESION_ANSWERUPDATE;
  ...
  /*      if (content == null || content.length() < 1) {
        ...
        if(presentAnswer != null){
            params.put("answer_id", presentAnswer.getAnswerId());
        }
        ...
        HttpRequestUtils.httpRequest(this, "回答问题", requestPath, params, "POST", new HttpRequestUtils.ResponseListener() {
            ...
            public void getResponseData(String response) {
                ...
                switch (common.getStatus()) {
                    case "1":
                        ToastUtil.showToast(EditeAnswerActivity.this, "编辑成功!");

                        et_content.setText("");
                        //mEditor.setHtml("");
                      //  clearCache();
                        SharedPreferencesUtils.setParam(EditeAnswerActivity.this,"isAnswerQuestion",true);
                        finish();
            ...
            switch (requestCode) {
                case GlobalValue.PHOTO_REQUESTCODE:
                    ...
                    if (mSelected != null && mSelected.size() > 0) {
                        ...
                        for(int i=0; i<mSelected.size(); i++) {
                            ...
                            urlStrs.add(PictureUtils.getPath(EditeAnswerActivity.this, uri));
                        }
                    }
                ...
                case GlobalValue.CAMERA_REQUESTCODE:
                    ...
                    try {
                        ...
                        File file = new Compressor.Builder(EditeAnswerActivity.this).setMaxHeight(1080).setMaxWidth(1920)
                    ...
                    if (dataFile != null) {
                        ...
                        ToastUtil.showToast(EditeAnswerActivity.this, "选择图片失败");
                    }
                    break;
            }
        }
