...
import com.lwc.shanxiu.interf.OnTransaction;
...
public class OperationDataBaseUtil extends SQLiteOpenHelper {
    ...
    public Cursor select(String table, String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String orderBy,
                         String limit) {
        SQLiteDatabase sqLiteDatabase = getRead();
        cursor = sqLiteDatabase.query(table, columns, selection, selectionArgs, groupBy, having, orderBy, limit); // 执行查询操作.
        return cursor;
    }
