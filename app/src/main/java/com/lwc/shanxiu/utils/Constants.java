...
public class Constants {
	...
	/** 应用根目录 */
	public static final String PATH_BASE = Environment.getExternalStorageDirectory().getAbsolutePath() + "/GUANXIU/";
	/** 拍照文件夹 */
	public static final String PATH_CAMERA = PATH_BASE + "Camera/";
	/** 拍照缓存文件 */
	public static final String PATH_IMAGE_TEMP = PATH_CAMERA + "temp.jpg";

	public static final int sequence = 2017;

	public static final String clientType = "maintenance";//  // user:用户版 maintenance：维修师版 person:个人版
}
